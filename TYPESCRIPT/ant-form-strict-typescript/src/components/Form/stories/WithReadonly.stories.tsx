...
export default {
  ...
  args: {
    ...
    initialValues: { authors: [], categories: [], description: 'Hello', images: [], title: 'Hello world' },
  } as Props<Book, keyof Book>,
  decorators: [withDesign],
} as Meta<typeof Form>;

export const WithReadonly: ComponentStory<typeof Form> = args => {
  return (
    <div>
      <Form<Book> {...args} readonly />
