...
export default function Edit() {
  ...
  return (
    <Dialog isOpen={true} aria-label="Edit invoice" onDismiss={onDismiss}>
      <h3>Edit invoice</h3>
      <Form method="post" replace style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <textarea name="description" id="description" value={formData.description} onChange={handleChange} rows={10} />
